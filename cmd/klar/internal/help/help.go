...
var LongDescription = `Shows details about a Klar CLI command or topic, including its usage and available options. This includes the 'klar help' command itself, which displays this message.
