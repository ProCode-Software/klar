...
func (n *EnumItem) Walk(v Visitor, c *Cursor) StopCode {
	return walkFields(v, n, c, walkNode{0, n.Identifier}, walkNode{1, n.Value}, walkSlice[*TypePair]{2, n.Parameters}, walkSlice[*Attribute]{3, n.Attributes})
}
...
func (n *Pair) Walk(v Visitor, c *Cursor) StopCode {
	return walkFields(v, n, c, walkNode{1, n.Key}, walkNode{2, n.Value})
}
