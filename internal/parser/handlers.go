...
func (p *Parser) handleNUD(kind lexer.TokenType) (res ast.ASTItem, handled bool) {
	...
	// Prefix/Unary
	case lexer.Minus, lexer.Plus, lexer.LogicalNot:
...
func (p *Parser) handleLED(
	...
	// Arithmetic
	case lexer.Plus, lexer.Minus, lexer.Times, lexer.Divide, lexer.Modulo:
	...
	// Assignment
	case lexer.PlusEqual, lexer.MinusEqual, lexer.ColonEqual, lexer.EqualSign:
...
func (p *Parser) handleTypeLED(kind lexer.TokenType, left ast.Type, bp BindingPower) (res ast.Type, handled bool) {
	switch kind {
	case lexer.Plus, lexer.Alternative:
