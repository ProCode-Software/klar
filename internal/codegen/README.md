...
See [docs/JavaScript/Representation.md](..//../docs/JavaScript/Representation.md) at the root of the repo for information about how Klar constructs are represented in JavaScript.
