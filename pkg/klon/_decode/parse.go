...
var (
	ErrUnterminatedString = goerrors.New("klon: unterminated string literal")
	ErrUnterminatedArray  = goerrors.New("klon: expected ']' to end array")
	ErrUnexpectedBracket  = goerrors.New("klon: unexpected ']'")
	ErrUnexpectedBrace    = goerrors.New("klon: unexpected '}'")
)
