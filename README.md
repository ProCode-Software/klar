...
- ⏩ **Progressive.** Unafraid to redesign features from other languages.
...
- Compiler (`internal`, `pkg`, `cmd`): [GNU General Public License v3.0](https://github.com/ProCode-Software/klar/blob/main/LICENSE-GPL)
